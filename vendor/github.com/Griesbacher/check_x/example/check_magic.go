...
func main() {
	...
	//evaluate your magic
	status1 := check_x.Evaluator{Warning: warn, Critical: crit}.Evaluate(measuredValue1)
	status2 := check_x.Evaluator{Warning: warn, Critical: crit}.Evaluate(measuredValue2)
